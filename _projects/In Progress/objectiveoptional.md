...
I spent a chunk of time experimenting with mechanics until I landed on a fun little **"weighted object"** system and a **slippery surface** mechanic. I used a collection of `TileMapLayer` nodes to toggle surfaces between normal and slippery, allowing for dynamic movement challenges as well as visual effects.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDg4NTUzNDEzLDYwODExNDA0LC00NDkxNT
c4MjddfQ==
-->